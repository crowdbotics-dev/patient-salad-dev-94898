"""
Django settings for patient_salad_dev_94898 project.
...
ROOT_URLCONF = 'patient_salad_dev_94898.urls'
...
WSGI_APPLICATION = 'patient_salad_dev_94898.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "patient_salad_dev_94898 API",
    "DESCRIPTION": "API documentation for patient_salad_dev_94898 App",
    "VERSION": "v1",
}
